...
namespace FOKE.Pages.Unit
{
    public class AssignedMembersModel : PagedListBasePageModel
    {
        ...
        public AssignedMembersModel(ISharedLocalizer sharedLocalizer, IMembershipFormRepository membershipFormRepository, IUnitRepository unitRepository)
        {
        ...
        public IActionResult OnGetGetDetails(string keyword, string searchText, long unitId)
        {
            var members = _unitRepository.GetMembersAssignedToUnit(unitId, keyword, searchText);
