...
namespace FOKE.Pages.Profession
{
    public class IndexModel : PagedListBasePageModel
    {
        ...
        public IActionResult OnPostExportData()
        {
            ...
            var empData = _professionRepository.ExportProfessionToExcel(Statusid, "");
            var tempFileName = empData.returnData;
            return new JsonResult(new { tFileName = tempFileName, fileName = "ProfessionMaster.xlsx" });
        ...
        public void setPagedListColumns()
        {
            ...
            objList.Add(new PageListFilterColumns { ColumName = "Profession", ColumnDescription = _sharedLocalizer.Localize("PROFESSION").Value });
